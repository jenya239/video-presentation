...
- **5 этапов производства**:
  1. **Резка металла** - болгарка режет 6м профиль на 12 кусков (4×2м вертикальные стойки + 8×0.5м горизонтальные поперечины), летят искры
  2. **Резка фанеры** - циркулярка распиливает листы на 2 полки 2000×500 мм, древесная пыль
  3. **Сварка рамы** - сварка MIG собирает 3D-раму из 4 вертикальных стоек и 8 поперечин, яркие искры в каждом соединении
...
- Правильная ориентация всех элементов конструкции
