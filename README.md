...
### 5. Construction Process (`construction.html`)
Реалистичная анимация строительства дома:
- **Реальные размеры материалов**:
  - Фундаментные блоки: 500x250x250 мм
  - Кирпичи: 250x65x120 мм
  - Бетонные блоки: 400x200x200 мм
  - Деревянные балки: 50x150 мм
  - Фанерные листы: 1220x2440x15 мм
  - Бетонные плиты: 1000x150x1000 мм
  - Кровельная черепица: 300x20x400 мм
- **8 этапов строительства**: Фундамент → Пол → Стены (3 слоя) → Рамы → Крыша → Покрытие
- Здание 6x8 метров, высота стен 3 метра
- Анимация появления каждого блока снизу
- Кирпичная кладка с правильной перевязкой (смещение через ряд)
- Проёмы для дверей и окон
- Каркас крыши с балками и стропилами
- Управление: пауза, скорость (0.5x - 5x), сброс
- Информационная панель с текущим этапом и размерами материалов
- Счётчик использованных материалов
- Вращающаяся камера
- Реалистичные тени
