...
- 8 планет с реальными наклонами орбит (7° для Меркурия, 97.8° для Урана и т.д.)
- 12 спутников (Луна, Фобос/Деймос, 4 луны Юпитера, 3 Сатурна)
- Кольца Сатурна
- 3 кометы с эллиптическими орбитами и хвостами
- 8000 звёзд с галактической структурой (диск + гало)
- **Клик на планету** → плавный пролёт камеры с вращением вокруг
- **Кнопка Overview** → возврат к общему виду системы
- Информационные панели с реальными данными
