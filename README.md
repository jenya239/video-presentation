...
- **50+ реальных звёзд из каталога**: Sirius (8.6 ly), Alpha Centauri (4.37 ly), Canopus, Vega, Arcturus, Rigel, Betelgeuse, Polaris и др.
- Звёзды с правильными координатами (RA/Dec), расстояниями и спектральными классами
- 12 спутников (Луна, Фобос/Деймос, 4 луны Юпитера, 3 Сатурна)
- Кольца Сатурна
- 3 кометы с эллиптическими орбитами
- Процедурные текстуры планет (не однотонные!)
