...
### 9. Nord Projects Ecosystem (`nord-projects.html`)
Стильная 3D визуализация микросервисной архитектуры проектов:
- **20 компонентов системы**:
  - Backend сервисы (7): casino-sg, bp-service, loyalty, notify, telegram, CMS
  - Frontend приложения (3): client, client2, client-core
  - Admin панели (3): casino-sg-admin, buffalopay-admin, casino-admin
  - Core библиотеки (2): nest-core, api-tools
  - Инфраструктура (2): SonarQube, VPN
  - Внешние сервисы (2): Jira, Git
- **Визуализация связей**: линии показывают зависимости между сервисами
- **Крупные текстовые подписи** (48px шрифт на 3D спрайтах)
- **Цветовое кодирование**: каждый тип компонента имеет свой цвет
- **Анимация**:
  - Плавное вращение всех узлов
  - Пульсация масштаба
  - Мигающие линии связей
  - 200 дрейфующих частиц (поток данных)
  - Автоматическое вращение камеры
- Киберпанк стиль: чёрный фон, неоновые цвета (#00ff88, #ff3366)
- Легенда с типами компонентов
