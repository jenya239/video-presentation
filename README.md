...
Простая 3D Tower Defense игра с автоматическим прогрессом:

- **Центральная турель**: 
  - Непрерывная стрельба по ближайшему врагу
  - Периодический запуск ракет с area damage
  - Автоматическая ротация и прицеливание
- **Автопрогресс**: 
...
- **Враги**: 
  ...
  - Движутся к центральной турели
  - Усиливаются с каждой волной (HP, скорость, урон)
- **Визуал**: 
